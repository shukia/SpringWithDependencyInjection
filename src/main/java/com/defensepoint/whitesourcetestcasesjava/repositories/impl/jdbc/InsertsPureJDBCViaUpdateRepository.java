...
@Component
@Slf4j
public class InsertsPureJDBCViaUpdateRepository implements SimpleEntityRepository {
    private final DataSource dataSource;
    private final NamedParameterJdbcTemplate jdbcTemplate;
    public InsertsPureJDBCViaUpdateRepository(DataSource dataSource, NamedParameterJdbcTemplate jdbcTemplate) {
    ...
    public SimpleEntity save(SimpleEntity entity){
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            statement.executeUpdate(String.format(QueryConstants.INSERT_SQL_SIMPLE_ENTITY_QUERY,entity.getField()));
