...
@Repository
@Slf4j
public class PreparedStatementInsertViaExecuteRepository implements SimpleEntityRepository {
    private final DataSource dataSource;
    private final NamedParameterJdbcTemplate jdbcTemplate;
    public PreparedStatementInsertViaExecuteRepository(DataSource dataSource, NamedParameterJdbcTemplate jdbcTemplate) {
