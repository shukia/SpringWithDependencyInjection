...
@Repository
@Slf4j
public class ExecuteBatchJDBCRepository implements SimpleEntityRepository {
    private final DataSource dataSource;
    private final NamedParameterJdbcTemplate jdbcTemplate;
    public ExecuteBatchJDBCRepository(DataSource dataSource, NamedParameterJdbcTemplate jdbcTemplate) {
    ...
    public SimpleEntity save(SimpleEntity entity){
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            statement.addBatch(String.format(QueryConstants.INSERT_SQL_SIMPLE_ENTITY_QUERY,entity.getField()));
